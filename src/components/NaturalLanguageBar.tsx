  ...
  return (
    <div className="bg-white border border-slate-200/80 p-3 sm:p-4 rounded-3xl shadow-xs relative overflow-hidden transition-all duration-300">
      ...
      <form onSubmit={handleParsePrompt} className="space-y-3">
        <div className="relative flex items-center bg-slate-50 border border-slate-200/80 rounded-2xl shadow-3xs p-1 focus-within:bg-white focus-within:border-brand/70 focus-within:ring-2 focus-within:ring-brand/10 transition-all">
          
          {/* Sparkles Icon Inside Bar */}
          <div className="pl-3.5 pr-1.5 text-brand shrink-0 flex items-center">
          ...
          <input
            ...
            className="w-full pl-0 pr-14 py-2 text-xs font-semibold text-slate-800 bg-transparent outline-none border-none placeholder:text-slate-400 placeholder:italic placeholder:font-medium placeholder:transition-all placeholder:duration-300"
          />
          
          <button
            type="submit"
            className="absolute right-1.5 p-2.5 bg-brand hover:bg-brand-hover text-white rounded-xl shadow-3xs hover:shadow-xs cursor-pointer active:scale-95 transition-all flex items-center justify-center"
        ...
        <div className="flex flex-wrap items-center gap-2 pt-0.5">
          ...
          <div className="flex flex-wrap gap-1.5">
            <button
              ...
              className="text-3xs bg-slate-50 text-slate-600 hover:text-brand hover:bg-brand-light border border-slate-200 hover:border-brand/35 rounded-full px-2.5 py-1 font-semibold cursor-pointer active:scale-95 transition-all"
            >
              "Retire by 52 (1.5L/mo)"
            </button>
            <button
              type="button"
